...
from .recorder import attach_prediction_recorder, save_recorded_predictions
...
def create_parser():
    ...
    predict_parser.add_argument('--log', help='Path to append to a prediction log file, defaults to not writing a log file. ')
