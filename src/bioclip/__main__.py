...
def create_parser():
    ...
    SUBSET_HELP = f"path to CSV file used to subset the TreeOfLife embeddings. CSV first column must be named one of {subset_labels}. When specified the --rank, --bins, and --cls arguments are not allowed."
