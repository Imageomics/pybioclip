...
### PIL Images
The predict() functions used in all the examples above allow passing an list of paths or a list of [PIL Images](https://pillow.readthedocs.io/en/stable/reference/Image.html).
